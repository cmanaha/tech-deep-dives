...
| Metric | Count |
|---|---|
| Documentation citations extracted | 196 |
| Unique documentation URLs checked | 151 |
| URLs resolving cleanly | 150 |
...
| URLs timed out | 0 |
| URLs erroring | 0 |
| Code citations extracted | 244 |
| Unique pinned files checked | 130 |
| Files present and long enough at the pinned ref | 130 |
| Of those, directory references (no line check) | 2 |
...
| OK | 200 | `https://aws.amazon.com/blogs/hpc/in-the-search-for-performance-theres-more-than-one-way-to-build-a-network/` | src/sections/SrdProtocol.tsx:106 | 1 | - |
| OK | 200 | `https://aws.amazon.com/blogs/hpc/optimizing-mpi-application-performance-on-hpc7a-by-effectively-using-both-efa-devices/` | src/sections/Sources.tsx:40 | 1 | - |
| OK | 200 | `https://aws.amazon.com/blogs/hpc/second-generation-efa-improving-hpc-and-ml-application-performance-in-the-cloud/` | src/sections/Sources.tsx:39 | 1 | - |
...
| OK | 200 | `https://aws.amazon.com/ec2/instance-types/trn2/` | src/sections/Sources.tsx:30 | 1 | - |
...
| OK | 200 | `https://cfd.direct/cloud/openfoam-hpc-aws-efa/` | src/sections/Sources.tsx:43 | 1 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/capacity-blocks-how.html` | src/data/pricing.ts:87 | 1 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-network-bandwidth.html` | src/sections/EnaVsEfa.tsx:87 | 2 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa-acc-inst-types.html` | src/data/instances.ts:32 | 5 | - |
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa-changelog.html` | src/sections/DataPath.tsx:106 | 4 | - |
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa-start-nccl.html` | src/sections/DataPath.tsx:112 | 4 | - |
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa-start-nixl.html` | src/sections/Libfabric.tsx:55 | 1 | - |
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa-start.html` | src/data/instances.ts:38 | 7 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa.html` | src/data/instances.ts:26 | 10 | - |
| OK | 200 | `https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ena-express.html` | src/sections/EnaVsEfa.tsx:81 | 2 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/ec2/latest/instancetypes/ac.html` | src/data/instances.ts:44 | 3 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/ec2/latest/instancetypes/hpc.html` | src/data/instances.ts:50 | 2 | - |
| OK | 200 | `https://docs.aws.amazon.com/eks/latest/userguide/create-node-class.html` | src/sections/EKSIntegration.tsx:87 | 1 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/eks/latest/userguide/ml-node-pools.html` | src/sections/TopologyApi.tsx:134 | 1 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/sagemaker/latest/dg/data-parallel-intro.html` | src/sections/SageMaker.tsx:95 | 2 | - |
| OK | 200 | `https://docs.aws.amazon.com/sagemaker/latest/dg/data-parallel-release-notes.html` | src/sections/SageMaker.tsx:97 | 1 | - |
| OK | 200 | `https://docs.aws.amazon.com/sagemaker/latest/dg/distributed-data-parallel-support.html` | src/sections/SageMaker.tsx:92 | 1 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-hyperpod-eks-operate-console-ui-governance-tasks-scheduling.html` | src/sections/TopologyApi.tsx:122 | 1 | - |
...
| OK | 200 | `https://docs.aws.amazon.com/sagemaker/latest/dg/train-get-capacity.html` | src/sections/SageMaker.tsx:78 | 1 | - |
| OK | 200 | `https://docs.aws.amazon.com/sagemaker/latest/dg/your-algorithms-training-efa.html` | src/sections/SageMaker.tsx:70 | 1 | - |
...
| OK | 200 | `https://karpenter.sh/docs/concepts/nodeclasses/` | src/sections/EKSIntegration.tsx:118 | 1 | - |
...
| DIR | `aws/karpenter-provider-aws` | `v1.14.0` | `pkg` | - | 0 | 0 | src/sections/TopologyApi.tsx:195 | - |
...
| OK | `amzn/amzn-drivers` | `b99452b70756b1b394b1e7ff238d4efbdca44c5b` | `kernel/linux/efa/RELEASENOTES.md` | - | 0 | 244 | src/sections/EfaDevice.tsx:86 | - |
...
| OK | `amzn/amzn-drivers` | `b99452b70756b1b394b1e7ff238d4efbdca44c5b` | `kernel/linux/efa/src/efa_data_verbs.c` | L324-L756 | 756 | 798 | src/sections/DataPath.tsx:53 | - |
| OK | `amzn/amzn-drivers` | `b99452b70756b1b394b1e7ff238d4efbdca44c5b` | `kernel/linux/efa/src/efa_io_defs.h` | L23-L93 | 93 | 455 | src/sections/DataPath.tsx:59 | - |
| OK | `amzn/amzn-drivers` | `b99452b70756b1b394b1e7ff238d4efbdca44c5b` | `kernel/linux/efa/src/efa_main.c` | L27-L38 | 785 | 1031 | src/sections/Operations.tsx:103 | - |
...
| OK | `amzn/amzn-drivers` | `b99452b70756b1b394b1e7ff238d4efbdca44c5b` | `kernel/linux/efa/src/efa.h` | L25-L26 | 99 | 502 | src/sections/EfaDevice.tsx:80 | - |
...
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `doc/efa-env-var.md` | - | 69 | 153 | src/sections/Libfabric.tsx:85 | - |
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `doc/topology-aware.md` | L122-L149 | 149 | 150 | src/sections/TopologyApi.tsx:167 | - |
...
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `include/tuner/nccl_ofi_tuner_process_config.h` | L30-L53 | 111 | 129 | src/sections/NcclOverEfa.tsx:120 | - |
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `RELEASENOTES.md` | L10-L16 | 16 | 1102 | src/sections/NcclOverEfa.tsx:152 | - |
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `src/Makefile.am` | L11 | 190 | 192 | src/sections/NcclOverEfa.tsx:82 | - |
...
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `src/nccl_ofi_rdma.cpp` | L234-L303 | 7407 | 7626 | src/sections/NcclOverEfa.tsx:97 | - |
...
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `src/platform-aws.cpp` | L43-L48 | 991 | 1089 | src/sections/NcclOverEfa.tsx:91 | - |
...
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `src/tuner/nccl_ofi_regions.cpp` | L2094-L2117 | 2117 | 2209 | src/sections/NcclOverEfa.tsx:121 | - |
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `src/tuner/nccl_ofi_tuner.cpp` | L138-L156 | 258 | 260 | src/sections/NcclOverEfa.tsx:113 | - |
| OK | `aws/aws-ofi-nccl` | `v1.20.0` | `topology/p4d-24xl-topo.xml` | L1-L26 | 26 | 40 | src/sections/NcclOverEfa.tsx:104 | - |
...
| OK | `aws/karpenter-provider-aws` | `4b2a2049469190a8a379668794e053207464b740` | `designs/efa-for-static-capacity.md` | - | 0 | 171 | src/sections/EKSIntegration.tsx:183 | - |
...
| OK | `awslabs/ai-on-eks` | `5e6282cb121f423e734caccb550a9f61c2935584` | `infra/base/terraform/eks.tf` | - | 0 | 528 | src/sections/EKSIntegration.tsx:185 | - |
...
| OK | `awslabs/awsome-distributed-ai` | `cb99a28a85c8333ddbad004221230dac967ddbab` | `micro-benchmarks/nccl-tests/kubernetes/nccl-tests-gb200.yaml` | - | 0 | 117 | src/sections/EKSIntegration.tsx:177 | - |
| OK | `awslabs/awsome-distributed-ai` | `cb99a28a85c8333ddbad004221230dac967ddbab` | `micro-benchmarks/nccl-tests/kubernetes/nccl-tests.yaml` | - | 0 | 85 | src/sections/EKSIntegration.tsx:176 | - |
| OK | `awslabs/awsome-distributed-ai` | `cb99a28a85c8333ddbad004221230dac967ddbab` | `micro-benchmarks/nccl-tests/nccl-tests.Dockerfile` | - | 0 | 130 | src/sections/EKSIntegration.tsx:182 | - |
...
| OK | `eksctl-io/eksctl` | `a5cb648e5bd6245a80e6b62b8817ce6fa1e6d7cd` | `userdocs/src/usage/nodegroup-managed.md` | - | 0 | 310 | src/sections/EKSIntegration.tsx:184 | - |
...
| OK | `NVIDIA/nccl` | `v2.30.4-1` | `src/graph/search.cc` | L181-L202 | 280 | 1407 | src/sections/NcclOverEfa.tsx:143 | - |
...
| OK | `ofiwg/libfabric` | `v2.6.0` | `man/fi_efa.7.md` | - | 681 | 721 | src/sections/Libfabric.tsx:59 | - |
...
| OK | `ofiwg/libfabric` | `v2.6.0` | `prov/efa/docs/efa_fabric_comparison.md` | L271 | 271 | 284 | src/sections/Libfabric.tsx:82 | - |
...
| OK | `ofiwg/libfabric` | `v2.6.0` | `prov/efa/src/efa_hmem.c` | L40-L116 | 116 | 627 | src/sections/Libfabric.tsx:69 | - |
| OK | `ofiwg/libfabric` | `v2.6.0` | `prov/efa/src/efa_prov_info.c` | L346-L356 | 356 | 795 | src/sections/Operations.tsx:112 | - |
...
| OK | `ofiwg/libfabric` | `v2.6.0` | `prov/efa/src/fi_ext_efa.h` | L11 | 11 | 141 | src/sections/Libfabric.tsx:81 | - |
| OK | `ofiwg/libfabric` | `v2.6.0` | `prov/efa/src/rdm/efa_rdm_mr.c` | L111-L126 | 169 | 828 | src/sections/Operations.tsx:114 | - |
| OK | `ofiwg/libfabric` | `v2.6.0` | `prov/efa/src/rdm/efa_rdm_msg.c` | L46-L102 | 102 | 1121 | src/sections/Libfabric.tsx:68 | - |
