...
const tierRows: TierRow[] = [
  ...
  },
  {
    ...
    latency: 'PCIe / NVLink-C2C copy (microseconds–low ms)',
    scope: 'One node',
...
const useCaseRows: UseCaseRow[] = [
  {
    ...
    tier: 'CPU / disk — the prefix is too big to keep pinned in HBM',
  },
  {
          ...
          <ColumnLayout columns={3} variant="text-grid">
            ...
            <div>
              ...
              <Box variant="p">
                ...
                engines over RDMA. That is disaggregation, not offload — covered in section
                10 and in the codebase tab. The framework is shared; the intent differs.
              </Box>
            </div>
          </ColumnLayout>
          <Alert type="info">
            <code>MultiConnector</code> composes several of these at once — e.g. an LMCache
      ...
      >
        <SpaceBetween size="m">
          <Box variant="p">
            ...
            storage backends, and KV reuse <em>across</em> engine instances — a prefix warmed
          ...
          <ColumnLayout columns={2} variant="text-grid">
            <div>
              ...
              <Box variant="p">
                ...
                targets — the deployment picks the tier mix.
              </Box>
            </div>
            <div>
              ...
              <Box variant="p">
                ...
                <code>LMCacheConnectorV1</code> — no engine fork required. The integration is
          ...
          <ColumnLayout columns={2} variant="text-grid">
            <div>
              ...
              <ul>
                ...
                <li>Reuse spans turns, sessions, or replicas — not just one request</li>
            ...
            <div>
              ...
              <ul>
                <li>Prefixes are short — recompute is cheaper than a round-trip</li>
                <li>Hit rate is low — you pay to stage KV that is never read back</li>
                <li>The remote store is slow or congested — load &gt; recompute</li>
      ...
      <ExpandableSection headerText="Operational tradeoffs (deep dive)">
        <SpaceBetween size="s">
          ...
          <Box variant="p">
            ...
            identity, not just the token prefix — a correctness requirement, not an
            optimization.
          </Box>
          <Box variant="p">
