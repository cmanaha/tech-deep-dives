...
const glossary: GlossaryEntry[] = [
  ...
  { acronym: 'scale-to-zero', fullForm: 'Scale to Zero', description: 'Scaling a SageMaker endpoint to 0 instances when idle; available only with Inference Components (MinInstanceCount 0); ~5 to 6 min cold start.' },
